...
class Produtos(models.Model):
    descricao_simplificada = models.CharField(max_length=100, blank=False, unique=False, null=True)
    unidade_medida = models.CharField(max_length=10, blank=False)
    categoria = models.CharField(max_length=30, blank=False)
    ...
    def __str__(self):
        return '000.'+str(self.id)+' - '+str(self.descricao_simplificada)+' ('+str(self.unidade_medida) +\
